...
export interface InitOutput {
  ...
  readonly _dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__ha6d67c60ba17ad8a_multivalue_shim: (a: number, b: number) => [number, number];
  readonly __externref_table_dealloc: (a: number) => void;
  readonly closure2916_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure3406_externref_shim: (a: number, b: number, c: any, d: any) => void;
